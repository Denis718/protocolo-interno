# Generated by Django 3.2.16 on 2023-05-08 12:49

import apps.validators.validators
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_nascimento', models.DateField(blank=True, null=True, validators=[apps.validators.validators.validate_data_nascimento])),
            ],
            options={
                'ordering': ['-id'],
            },
